...
class DivisiModel
{
    ...
    // ===============================
    // Update data divisi + sync snapshot ke user + invalidate cache
    public function update($id, $nama)
    {
        ...
        try {
            ...
            if ($result) {
                // Sync snapshot ke user
                $syncStmt = $this->pdo->prepare("UPDATE {$this->tableUser} SET nama_divisi_snapshot = ? WHERE id_divisi = ?");
    ...
    // ===============================
    // Hapus divisi + invalidate cache (snapshot user tetap ada, tidak diubah)
